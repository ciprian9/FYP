...
public class NotificationGenerator {
    public static final String NOTIFY_PREVIOUS = "com.example.nicholasanton.myapplication.previous";
    public static final String NOTIFY_DELETE = "com.example.nicholasanton.myapplication.delete";
    public static final String NOTIFY_PAUSE = "com.example.nicholasanton.myapplication.pause";
    public static final String NOTIFY_PLAY = "com.example.nicholasanton.myapplication.play";
    public static final String NOTIFY_NEXT = "com.example.nicholasanton.myapplication.next";
